                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yonghuTypesDiv">
                                        <label>状态</label>
                                        <select style="width: 450px" id="yonghuTypesSelect" name="yonghuTypes" class="form-control">
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 yonghuTimeDiv">
                                        <label>会员截止日期</label>
                                        <input style="width: 450px" id="yonghuTime-input" name="yonghuTime" type="text" class="form-control layui-input">
                                    </div>
...
<script>
    ...
    function dateTimePick() {
        if (window.sessionStorage.getItem('role') == '管理员'  || window.sessionStorage.getItem('role') == '工作人员') {
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $('#yonghuTime-input').attr('readonly', 'readonly');
        }
        else{
            // alert("未知情况.......");
