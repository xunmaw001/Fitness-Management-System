                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 gongzuoNameDiv">
                                        <label>工作人员姓名</label>
                                        <input style="width: 450px" id="gongzuoName" name="gongzuoName" class="form-control"
                                               placeholder="工作人员姓名">
                                    </div>
                                    <div class="form-group col-md-6 gongzuoPhoneDiv">
                                        <label>工作人员手机号</label>
                                        <input style="width: 450px" id="gongzuoPhone" name="gongzuoPhone" class="form-control"
                                               onchange="gongzuoPhoneChickValue(this)"  placeholder="工作人员手机号">
                                    </div>
                                    <div class="form-group col-md-6 gongzuoIdNumberDiv">
                                        <label>工作人员身份证号</label>
                                        <input style="width: 450px" id="gongzuoIdNumber" name="gongzuoIdNumber" class="form-control"
                                               onchange="gongzuoIdNumberChickValue(this)"  placeholder="工作人员身份证号">
                                    </div>
                                    <div class="form-group col-md-6 gongzuoPhotoDiv">
                                        <label>工作人员头像</label>
