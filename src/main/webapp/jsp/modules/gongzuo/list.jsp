        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">工作人员管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">工作人员列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">工作人员列表</h3>
    ...
    <!-- 本表的查询条件 -->
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("gongzuo/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addgongzuo", "addgongzuo");
            window.location.href = "add-or-update.jsp"
        }
        ...
        function resetPassword(id) {
            http("gongzuo/resetPassword", "GET",{
                id:id
            }, (res) => {
                if(res.code == 0){
                    getDataList();
