                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>消费类型编码</label>
                                    <input id="codeIndex" name="codeIndex" readonly class="form-control"
                                           onchange="codeIndexChickValue(this)"  placeholder="编码">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>消费类型名称</label>
                                        <input id="indexName" name="indexName" readonly class="form-control"
                                               placeholder="消费类型名称">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>金额</label>
                                        <input type="number" id="beizhu" name="beizhu" class="form-control"
                                               placeholder="金额">
                                    </div>
...
<script>
    ...
    var tableName = "dictionaryKapian";
